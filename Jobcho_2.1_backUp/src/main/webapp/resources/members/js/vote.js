...
$(document).ready(function(){
	...
	function insertVoteResultAction(item){
		...
		console.log(vote_num);
		var member_num = $("#vote_member_num").val();
		console.log(member_num);
		var vote_result1 = null;
		var vote_result2 = null;
		var vote_result3 = null;
		var vote_result4 = null;
		var vote_result5 = null;
